      ...
      <main className="flex-1 pt-28">
        ...
        <section className="px-6 py-16">
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition duration-300">
              ...
              <p className="text-gray-700 text-sm text-center">
                Send and receive funds instantly, create group savings pools,
                and track balances easily.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition duration-300">
              ...
              <p className="text-gray-700 text-sm text-center">
                Join or create pools, see progress bars for pool goals, and
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition duration-300">
              ...
              <p className="text-gray-700 text-sm text-center">
                Receive your share automatically from savings pools, no manual
                transfers, no waiting. Payments are deposited directly into your
                account.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition duration-300">
              ...
              <p className="text-gray-700 text-sm text-center">
                Quickly send money to anyone using their phone number or email.
                Funds are transferred directly to their account safely and
                instantly.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition duration-300 max-w-6xl mx-auto mt-8">
            ...
            <p className="text-gray-700 text-sm text-center">
              Stay updated in real-time! Get WhatsApp notifications for every
              pool event—new members joining, payments made, payments deducted,
              and more.
            </p>
          </div>
        </section>
